...
extern "C" YEP_LOCAL_SYMBOL YepStatus _yepMath_Sin_V64f_V64f_Default(const Yep64f *YEP_RESTRICT xPointer, Yep64f *YEP_RESTRICT yPointer, YepSize length) {
	...
	while (length-- != 0) {
		...
		const Yep64f y = yepBuiltin_Sin_64f_64f(x);
		*yPointer++ = y;
	}
	return YepStatusOk;
}
