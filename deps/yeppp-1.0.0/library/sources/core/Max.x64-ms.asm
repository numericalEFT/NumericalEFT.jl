...
_yepCore_Max_V32fV32f_V32f_SandyBridge:
	...
	VMOVUPS ymm13, [rcx]
	ADD rdx, 224
	VMAXPS ymm12, ymm12, ymm10
	VMOVAPS [byte r8 + 64], ymm5
	VMOVUPS ymm4, [byte rcx + 32]
	VMOVUPS ymm0, [rdx]
	VMAXPS ymm6, ymm6, ymm11
...
_yepCore_Max_V64fV64f_V64f_SandyBridge:
	...
	VMOVUPD ymm13, [rcx]
	ADD rdx, 224
	VMAXPD ymm12, ymm12, ymm10
	VMOVAPD [byte r8 + 64], ymm5
	VMOVUPD ymm4, [byte rcx + 32]
	VMOVUPD ymm0, [rdx]
	VMAXPD ymm6, ymm6, ymm11
