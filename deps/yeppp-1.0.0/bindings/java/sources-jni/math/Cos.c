...
JNIEXPORT void JNICALL Java_info_yeppp_Math_Cos_1V64f_1V64f(JNIEnv *env, jclass class, jdoubleArray xArray, jint xOffset, jdoubleArray yArray, jint yOffset, jint length) {
	...
	status = yepMath_Cos_V64f_V64f(&xPointer[xOffset], &yPointer[yOffset], length);
