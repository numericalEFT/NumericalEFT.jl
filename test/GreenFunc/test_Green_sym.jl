...
@testset "GreenSymFunc" begin
    ...
    @testset "GreenSym2DLR" begin
            ...
            for (c1i, c1) in enumerate(color_n)
                for (c2i, c2) in enumerate(color_n)
                    ...
                    for (ti, t) in enumerate(green_freq.dlrImGrid.n)
                        green_dum_Im[c1i, c2i, qi, ti] = Gn_Im[ti]
                    end
        ...
        green_freq1 = GreenSym2DLR{ComplexF64}(:green, GreenFunc.IMFREQ, β, isFermi, Euv, sgrid; :dynamic=>green_dum)
        #green_freq.dynamic = green_dum
        #green_freq.dynamicRl = green_dum_Rl
        #green_freq.dynamicIm = green_dum_Im
        green_tau = toTau(green_freq1)
    ...
    @testset "find" begin
        ...
        green_linear = GreenSym2DLR{ComplexF64}(:green, GreenFunc.IMFREQ, β, isFermi, Euv, sgrid)     
        ...
        #green_linear = GreenSym2DLR{ComplexF64}(:green, GreenFunc.IMFREQ, β, isFermi, Euv, sgrid; :dynamic=>green_dum)
